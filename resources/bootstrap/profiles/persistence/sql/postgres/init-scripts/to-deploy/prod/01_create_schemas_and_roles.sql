...
{{#project.profiles.persistence-sql.deployment.to-deploy.rds.environment.prod.database.other-users.keycloak.enabled}}
{{>bootstrap/profiles/persistence/sql/postgres/init-scripts/create_schemas_and_roles.keycloak.sql}}
{{/project.profiles.persistence-sql.deployment.to-deploy.rds.environment.prod.database.other-users.keycloak.enabled}}

{{#project.profiles.persistence-sql.deployment.to-deploy.rds.environment.prod.database.other-users.grafana.enabled}}
