...
export COMPOSE_FILE="docker-compose.yml:docker-compose.dev.yml:docker-compose.postgres.common-dev-ci.yml:docker-compose.keycloak.yml:docker-compose.keycloak.common-dev-ci.yml"
